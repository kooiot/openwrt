...
#define YT8531_LED_TXACT_BLK_EN         0x0400
#define YT8531_LED_RXACT_BLK_EN         0x0200
#define YT8531_GT_ON_EN                 0x0040
#define YT8531_HT_ON_EN                 0x0020
#define YT8531_BT_ON_EN                 0x0010
...
{                          
        ...
        printk("Entry: %s\n", __func__);
        // Link
        val = YT8531_GT_ON_EN | YT8531_HT_ON_EN | YT8531_BT_ON_EN;
        ret = ytphy_write_ext(phydev, YT8531_LED1_CFG, val);
        if (ret < 0)
                return ret;
        printk("%s: Write val 0x%x to reg 0x%x is success!\n", __func__, val, YT8531_LED1_CFG);
        
        // tx/rx act
        val = YT8531_LED_TXACT_BLK_EN | YT8531_LED_RXACT_BLK_EN |
                YT8531_GT_ON_EN | YT8531_HT_ON_EN | YT8531_BT_ON_EN;
        ret = ytphy_write_ext(phydev, YT8531_LED2_CFG, val);
        if (ret < 0)
                return ret;

        printk("%s: Write val 0x%x to reg 0x%x is success!\n", __func__, val, YT8531_LED2_CFG);
        return 0;
}
