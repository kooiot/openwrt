...
#endif  /* defined(SS_SUPPORT_CE_V3_2) || defined(SS_SUPPORT_CE_V4) */
...
#endif	/* defined(SS_SUPPORT_CE_V3_2) || defined(SS_SUPPORT_CE_V5) || defined(SS_SUPPORT_CE_V4) */
...
#define SS_HASH_SW_PADDING  /* In 1890, multi-task operations must use software padding */
#undef SS_XTS_MODE_ENABLE
#undef SS_RSA_ENABLE
#undef SS_HASH_HW_PADDING
#endif
