...
inline u32 sunxi_spi_bit_qry_irq_pending_xenomai(struct sunxi_spi *sspi)
{
...
// void sunxi_spi_bit_ss_polarity_xenomai(struct sunxi_spi *sspi, bool pol)
// {
// 	u32 reg_old, reg_new;
...
// void sunxi_spi_bit_set_cs(struct sunxi_spi *sspi, bool status)
// {
// 	int ret;
...
// 	sunxi_spi_bit_ss_polarity_xenomai(sspi, !(spi->mode & SPI_CS_HIGH));
...
void sunxi_spi_bit_handler_xenomai(struct sunxi_spi *sspi)
{
	...
	status = sunxi_spi_bit_qry_irq_pending_xenomai(sspi);
