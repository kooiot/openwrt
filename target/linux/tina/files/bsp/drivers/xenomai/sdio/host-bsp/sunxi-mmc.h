...
#define DRIVER_RIVISION "v5.17 2022-12-16 16:22"
...
#define SUNXI_SC_EN_RETRY					0x8
	/**If set this bit,when use rtdm_sunxi_check_r1_ready_may_sleep,
...
#define MMC_SUNXI_CAP3_RDPST	(1 << 3)
	...
	struct work_struct sunxi_handle_bottom_work;
	int debuglevel;
	u32 async;
	ktime_t rcd_mtx;
...
extern void sunxi_mmc_dumphex32(struct sunxi_mmc_host *host, char *name, char *base, int len);
