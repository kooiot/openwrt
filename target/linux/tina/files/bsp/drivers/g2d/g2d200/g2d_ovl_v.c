...
__s32 g2d_ovl_v_set_extract(struct ovl_v_submodule *p_ovl_v, __u32 format, __u32 inw,
		      __u32 inh, __u32 outw, __u32 outh)
{
	__s32 ret = -1;
	...
	case G2D_FORMAT_YUV422_PLANAR: {
		p_reg->hor_down_sample0.dwval = (outw << 16) | inw;
		p_reg->hor_down_sample1.dwval = (outw << 15) | ((inw + 1) >> 1);
		p_reg->ver_down_sample0.dwval = (outh << 16) | inh;
		p_reg->ver_down_sample1.dwval = (outh << 16) | inh;
		break;
	}
	case G2D_FORMAT_Y8:
	...
	case G2D_FORMAT_YUV420UVC_U1V1U0V0: {
		...
		p_reg->hor_down_sample1.dwval = (outw << 15) | ((inw + 1) >> 1);
		p_reg->ver_down_sample0.dwval = (outh << 16) | inh;
		p_reg->ver_down_sample1.dwval = (outh << 15) | ((inh + 1) >> 1);;
		break;
	}
	...
	case G2D_FORMAT_YUV411UVC_U1V1U0V0: {
		p_reg->hor_down_sample0.dwval = ((outw) << 16) | inw;
		p_reg->hor_down_sample1.dwval = ((outw) << 14) | ((inw + 3) >> 2);
		p_reg->ver_down_sample0.dwval = ((outh) << 16) | inh;
		p_reg->ver_down_sample1.dwval = ((outh) << 16) | inh;
		break;
	}
	default: {
		p_reg->hor_down_sample0.dwval = ((outw) << 16) | inw;
		p_reg->hor_down_sample1.dwval = ((outw) << 16) | inw;
		p_reg->ver_down_sample0.dwval = ((outh) << 16) | inh;
		p_reg->ver_down_sample1.dwval = ((outh) << 16) | inh;
	}
	}
...
g2d_ovl_v_submodule_setup(struct g2d_frame *p_frame)
{
