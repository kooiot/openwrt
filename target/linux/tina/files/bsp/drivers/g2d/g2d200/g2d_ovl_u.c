			   ...
			   struct g2d_rcq_mem_info *p_rcq_info)
{
	...
	p_ovl_u->reg_info->size = sizeof(struct g2d_mixer_ovl_u_reg);
...
static __u32 ovl_u_get_reg_block_num(struct ovl_u_submodule *p_ovl_u)
{
	if (p_ovl_u)
...
static __s32 ovl_u_get_reg_block(struct ovl_u_submodule *p_ovl_u,
...
static struct g2d_mixer_ovl_u_reg *ovl_u_get_reg(struct ovl_u_submodule *p_ovl_u, __u32 sel)
{
...
static void ovl_u_set_block_dirty(struct ovl_u_submodule *p_ovl_u, __u32 blk_id, __u32 dirty)
{
...
static __u32 ovl_u_get_rcq_mem_size(struct ovl_u_submodule *p_ovl_u)
{
	return G2D_RCQ_BYTE_ALIGN(sizeof(struct g2d_mixer_ovl_u_reg)) *
	       p_ovl_u->reg_blk_num;
}
...
g2d_ovl_u_submodule_setup(struct g2d_frame *p_frame)
{
	...
	p_ovl_u->get_reg_block_num = ovl_u_get_reg_block_num;
	p_ovl_u->get_reg_block = ovl_u_get_reg_block;
	p_ovl_u->get_reg = ovl_u_get_reg;
	p_ovl_u->set_block_dirty = ovl_u_set_block_dirty;
	p_ovl_u->get_rcq_mem_size = ovl_u_get_rcq_mem_size;
