...
{
	G2D_DRV_DBG("g2d rot irq\n");
	if (rot_glb->rot_int.bits.rot_irq & 0x1) {
		rot_glb->rot_int.bits.rot_irq = 1;
		return 1;
	}
	return 0;
}

__s32 g2d_rot_irq_en(void)
{
	rot_glb->rot_int.bits.finish_irq_en = 1;
	return 0;
}

__s32 g2d_rot_start(void)
{
	rot_glb->rot_ctrl.bits.start = 1;
	return 0;
}


__s32 g2d_top_open(void)
{
