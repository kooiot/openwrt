...
union g2d_mixer_ovl_mem_coor {
	unsigned int dwval;
	struct {
		unsigned int lay_xcoor:13;
		unsigned int res0:3;
		unsigned int lay_ycoor:13;
		unsigned int res1:3;
	} bits;
};
...
union g2d_mixer_ovl_down_sample_phase {
	unsigned int dwval;
	struct {
		unsigned int y_phase:14;
		unsigned int res0:2;
		unsigned int c_phase:14;
		unsigned int res1:2;
	} bits;
};
...
struct g2d_mixer_ovl_v_reg {
	...
	/* 0x40 */
	union g2d_mixer_ovl_down_sample_phase hor_down_sample_phase;
	union g2d_mixer_ovl_down_sample_phase ver_down_sample_phase;
};
...
union g2d_dither_rand_bits {
	unsigned int dwval;
	struct {
		unsigned int rand_num_bits:4;
		unsigned int res0:28;
	} bits;
};

union g2d_dither_random_generator {
	unsigned int dwval;
	struct {
		unsigned int rand_generator:32;
	} bits;
};

struct g2d_dither_reg {
	union g2d_dither_ctl dither_ctl;
	union g2d_dither_rand_bits dither_ran_bits;
	union g2d_dither_random_generator dither_random_generator[2];
};
