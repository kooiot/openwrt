...
#define G2D_ROT_RCQ_USED 1
#else
#define G2D_MIXER_RCQ_USED 1
#define G2D_ROT_AHB_USED 1
#endif
/* #define G2D_MIXER_RCQ_USED 0 */
/* #define G2D_MIXER_AHB_USED  1*/
/* #define G2D_ROT_AHB_USED 1*/

#if IS_ENABLED(CONFIG_AW_FPGA_S4) || defined(CONFIG_AW_FPGA_V7)
...
typedef struct {
	struct cdev *g2d_cdev;
	struct class *g2d_class;
	struct device *dev;
	dev_t devid;
