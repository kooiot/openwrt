...
/* #define FPGA_VER */
#if !IS_ENABLED(CONFIG_AW_KERNEL_ORIGIN) || IS_ENABLED(CONFIG_ARCH_SUN252IW1)
#define SUNXI_MEM
#endif
#define disp_sync_video 1

#if IS_ENABLED(CONFIG_ARCH_SUN252IW1)
#define VIN_CACHE_CLEAN_INVALID
#endif
...
#if !IS_ENABLED(CONFIG_ARCH_SUN50IW3P1) && !IS_ENABLED(CONFIG_ARCH_SUN50IW6P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW12P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW17P1) && \
	!IS_ENABLED(CONFIG_ARCH_SUN8IW15P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW16P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW19P1) && \
	!IS_ENABLED(CONFIG_ARCH_SUN50IW9) && !IS_ENABLED(CONFIG_ARCH_SUN8IW20) && !IS_ENABLED(CONFIG_ARCH_SUN20IW1)
...
#if IS_ENABLED(CONFIG_ARCH_SUN252IW1)
#define OUTPUT_EMBED_DATA
#endif

#if IS_ENABLED(CONFIG_ARCH_SUN8IW22)
#define MIPI_SUPPORT_MULTIPLEX
#endif

#if !IS_ENABLED(CONFIG_ARCH_SUN50IW3P1) && !IS_ENABLED(CONFIG_ARCH_SUN50IW6P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW12P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW17P1) && \
	!IS_ENABLED(CONFIG_ARCH_SUN8IW15P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW16P1) && !IS_ENABLED(CONFIG_ARCH_SUN8IW19P1) && \
	!IS_ENABLED(CONFIG_ARCH_SUN50IW10) && !IS_ENABLED(CONFIG_ARCH_SUN50IW9) /* first step */
#if !IS_ENABLED(CONFIG_ARCH_SUN8IW20) && !IS_ENABLED(CONFIG_ARCH_SUN20IW1) /* second step */
#if !IS_ENABLED(CONFIG_ARCH_SUN8IW21P1) && !IS_ENABLED(CONFIG_ARCH_SUN55IW3P1) && !IS_ENABLED(CONFIG_ARCH_SUN55IW6P1) && !IS_ENABLED(CONFIG_ARCH_SUN60IW1P1) && \
	!IS_ENABLED(CONFIG_ARCH_SUN60IW2P1) && !IS_ENABLED(CONFIG_ARCH_SUN65IW1P1) && !IS_ENABLED(CONFIG_ARCH_SUN300IW1P1) /* third step */
#if !IS_ENABLED(CONFIG_ARCH_SUN8IW22) /* fourth step */
#define ISP_610
#define TDM_V230
#endif /* end of fourth step */
#define VIPP_213
#define CSIC_DMA_VER_150_000
#define VIPP_ALLMASK_BK
#else /* else of third step */
#define VIPP_200
#define ISP_600
#define TDM_V200
#define CSIC_DMA_VER_140_000
#endif /* end of third step */
#define MIPI_PING_CONFIG
#if IS_ENABLED(CONFIG_AW_DMC_DEVFREQ) && IS_ENABLED(CONFIG_VIN_SDRAM_DFS)
#define CSIC_SDRAM_DFS
#endif
#endif /* end of second step */
...
#elif IS_ENABLED(CONFIG_AW_RPROC_FAST_BOOT) && IS_ENABLED(CONFIG_AW_IPC_FASTBOOT)
#define VIN_INIT_DRIVERS(fn) arch_initcall(fn)
