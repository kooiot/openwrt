...
struct prs_fps_ds {
	unsigned char ch0_fps_ds;
	unsigned char ch1_fps_ds;
	unsigned char ch2_fps_ds;
	unsigned char ch3_fps_ds;

	unsigned short ch0_frm_data_mask;
	unsigned short ch1_frm_data_mask;
	unsigned short ch2_frm_data_mask;
	unsigned short ch3_frm_data_mask;
};

int csic_prs_set_base_addr(unsigned int sel, vin_dma_addr_t addr);
