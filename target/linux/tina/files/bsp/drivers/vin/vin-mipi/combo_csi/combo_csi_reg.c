...
int cmb_csi_set_top_base_addr(vin_dma_addr_t addr)
{
...
int cmb_csi_set_phy_base_addr(unsigned int sel, vin_dma_addr_t addr)
{
...
int cmb_csi_set_port_base_addr(unsigned int sel, vin_dma_addr_t addr)
{
	if (sel > VIN_MAX_MIPI - 1)
		return -1;
