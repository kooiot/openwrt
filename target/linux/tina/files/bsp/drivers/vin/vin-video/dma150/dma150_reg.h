...
#ifndef __CSIC__DMA150__REG__H__
#define __CSIC__DMA150__REG__H__
...
extern int dma_virtual_find_ch[9];
extern int dma_virtual_find_logic[9];
extern int dma_virtual_find_sel[9];
#else
extern int dma_virtual_find_ch[18];
extern int dma_virtual_find_logic[18];
extern int dma_virtual_find_sel[18];
#endif
...
enum ve_online_enc_mode {
	NEW_ONLINE_ENCODE_SOLUTION = 0,
	OLD_ONLINE_ENCODE_SOLUTION,
};
...
enum dma_int_sel {
	...
	DMA_INT_PARA_LOAD_UNFINISH_TRIG = 0X100,
	...
	DMA_INT_PIXEL_REDUNDANT = 0x100000,
	DMA_INT_LINE_MISS = 0x200000,
	DMA_INT_LINE_REDUNDANT = 0x400000,
	DMA_INT_LACK_HBLANK = 0x800000,
...
void csic_dma_ve_online_sensor_chn_en(unsigned int sel, unsigned int id);
...
#endif /* __CSIC__DMA150__REG__H__ */
